                        ...
                        <div class="mb-0">
                            ...
                            <div class="row gx-10 mb-5">
                                ...
                                <div class="col-lg-6 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid datepicker" id="" placeholder="Pick a date" required name="due_date" />
                                    <!--end::Input-->
                                </div>
                                @endif
                                <!--end::Input group-->
                                ...
                                <div class="col-lg-6 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input  class="form-control form-control-solid datepicker" placeholder="Pick a date" required name="payment_date"/>
                                    <!--end::Input-->
                                </div>
                                @endif
                                <!--end::Input group-->
                                ...
                                <div class="col-lg-6 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid datepicker" placeholder="Pick a date" required name="commande_date" />
                                    <!--end::Input-->
                                </div>
                                @endif
                                <!--end::Input group-->
                                ...
                                <div class="col-lg-6 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input  class="form-control form-control-solid datepicker" placeholder="Pick a date" required name="reception_date"  />
                                    <!--end::Input-->
                                </div>
                                @endif
                                <!--end::Input group-->
                                ...
                                <div class="col-lg-6 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="" required name="document_number" />
                                    <!--end::Input-->
                                </div>
                                @endif
                                <!--end::Input group-->
                                ...
                                <div class="col-lg-6 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="" required name="recipient" />
                                    <!--end::Input-->
                                </div>
                                @endif
                                @if($data['type'] ==='devis' || $data['type']  ==='commandes' ||$data['type']  ==='livraisons' ||$data['type']  ==='factures' || $data['type']==='bons' ||  $data['type']==='reception' ||  $data['type'] ==='demandes' ||  $data['type']  ==='achats')
                                <div class="col-lg-12 mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="" required name="object" />
                                    <!--end::Input-->
                                </div>
                                @endif
                                <!--end::Input group-->
                                ...
                                <div class="table-responsive mb-10">
                                    ...
                                    <table class="table table-row-dashed  table-row-gray-300 gy-7" data-kt-element="items">
                                        ...
                                        <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                            <td class="pe-7">
                                                <input id="tags" type="text"  onkeyup="javascript:autoComplete($(this))"  class="form-control form-control-solid mb-2 item_invoice_name" name="row[0][name]" placeholder="Item name" />
                                                <input type="hidden" class=" item_invoice_id d-none" name="row[0][id]" value="" />
                                            </td>
                                            <td class="ps-0">
                                                <select data-placeholder="Select currency" class="form-select form-select-solid  item_invoice_units"  name="row[0][unity]" data-placeholder=" UNITÉ ?">
                                            ...
                                            <td class="ps-0">
                                                <input class="form-control form-control-solid item_invoice_quantity" type="number" min="0"  value="0.00"  name="row[0][quantity]" placeholder="0" data-kt-element="quantity" />
                                            </td>
                                            <td class="pt-8 text-end text-nowrap">
                                                <input type="text" class="form-control form-control-solid text-end  item_invoice_price" name="row[0][price]" placeholder="0.00" value="0.00" data-kt-element="price" />
                                            </td>
                                            <td class="pt-8 text-end text-nowrap">$
                                    ...
                                    <table class="table d-none " data-kt-element="item-template">
                                        <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                            <td class="pe-7">
                                                <input type="text"  onkeyup="javascript:autoComplete($(this))" class="form-control form-control-solid mb-2 item_invoice_name  "  placeholder="Item name" />
