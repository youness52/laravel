...
@section('content')
    <div class="nk-content-body">
        <form id="account_form" method="post" action="{{route('client.update',$data['account']['id'])}}" autocomplete="off"  >
            @csrf()
            @method('put')
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Modification de client</h3>
                        <div class="nk-block-des text-soft">
                            <p>Vous avez un total de 2 595 clients.</p>
                        </div>
                    </div>
