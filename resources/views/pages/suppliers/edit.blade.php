...
@section('content')
    <div class="nk-content-body">
        <form id="account_form" method="post" action="{{route('supplier.update',$data['account']['id'])}}" autocomplete="off"  >
            @csrf()
            @method('put')
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Modification de fournisseur</h3>
                        <div class="nk-block-des text-soft">
                            <p>Vous avez un total de 2 595 Fournisseurs.</p>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="raison_sociale" value="{{$data['account']['name']}}" name="raison_sociale" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="ref" name="ref" value="{{$data['account']['ref']}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="rc" name="rc" value="{{$data['account']['rc']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="fv-email" name="ice" value="{{$data['account']['ice']}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="iftax" name="iftax" value="{{$data['account']['iftax']}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="email" name="email" value="{{$data['account']['email']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="website" name="website" value="{{$data['account']['website']}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group py-2">
                                            ...
                                            <div class="form-control-wrap ">
                                                <select class="form-control form-select" id="taille" name="taille" data-placeholder="Select a option" required>
                                                    <option label="empty" value=""></option>
                                                    <option value="1" selected >1 salarié</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="phone" name="phone" value="{{$data['account']['phone']}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="mobile" name="mobile" value="{{$data['account']['mobile']}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="fax" name="fax"  value="{{$data['account']['fax']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="discount" name="discount"   value="{{$data['account']['discount']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <textarea  class="form-control py-1" id="note" name="note" required rows="4">{{$data['account']['note']}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row ">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="address" name="address"  value="{{$data['account']['address']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="zipcode" name="zipcode" value="{{$data['account']['zipcode']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text" class="form-control" id="city" name="city" value="{{$data['account']['city']}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
