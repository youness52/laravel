...
@section('javascript')
<script>
    const buttonAdd = document.getElementById('addPropertie');
    buttonAdd.addEventListener("click", ()=>{
        store('{{route('propertie.store')}}','add_form_propertie')
        $('#ModelAddPropertie').modal('hide');


    });


    const propertieEdit = (id)=>{
        instance.get(`admin/propertie/${id}/edit`)
            .then(function (response) {
                // handle success
                $('#name').val(response.data.name);
                $('#editTableButton').attr(`onClick`, "tableUpdate('/admin/propertie/"+response.data.id+"','edit_form_propertie')");
                $('#ModelEditPropertie').modal('show');
    ...
    const tableUpdate =(url,form)=> {
        $('#ModelEditPropertie').modal('hide');
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">List des Propriétés </h3>
                    <div class="nk-block-des text-soft">
                        <p>Vous avez un total de 2,595 propriétés.</p>
                    </div>
                                    ...
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="link-list-opt no-bdr">
                                                <li><a href="#" data-toggle="modal" data-target="#ModelAddPropertie"><span> Nouvelle propriétés</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
        ...
        <div class="nk-block">
            <div class="card card-bordered card-stretch">
                <div class="card-inner-group">
                    ...
                    <div class="card-inner p-0">
                        <div class="nk-tb-list nk-tb-ulist">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col"><span class="sub-text">Nom de la propriété</span></div>
                            ...
                            @if(isset($data['propertie']))
                                @foreach($data['propertie'] as $key => $item)
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden">
                                                    <button class="btn btn-trigger btn-icon" onclick="propertieEdit({{$item->id}})" data-toggle="tooltip" data-placement="top" title="edit">
                                                        <em class="icon ni ni-edit"></em>
                                                    </button>
                                                </li>
                                                <li class="nk-tb-action-hidden">
                                                    <form action="{{route('propertie.destroy',$item->id)}}" method="post">
                                                        @csrf()
                                                        @method('DELETE')
                                                ...
                                                <li>
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li>
                                                                    <a href="javascript:propertieEdit({{$item->id}})" ><em class="icon ni ni-edit"></em><span>Edit</span></a>
                                                                </li>
                                                                <li>
                                                                    <form action="{{route('propertie.destroy',$item->id)}}" method="post">
                                                                        @csrf()
                    ...
                    <!-- .card-inner -->
                    {{ $data['propertie']->links('vendor.pagination.custom')}}
                    <!-- .card-inner -->
                </div><!-- .card-inner-group -->
            </div><!-- .card -->
        </div><!-- .nk-block -->
    </div>
    <div class="modal fade" id="ModelEditPropertie">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title">Modifer Propriétés</h5>
                    <form action="#" class="mt-2" id="edit_form_propertie">
                        <div class="row g-gs">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="name">Nom de la Propriétés</label>
    ...
    <div class="modal fade" id="ModelAddPropertie">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    <h5 class="modal-title"> Nouvelle Propriétés</h5>
                    <form action="#" class="mt-2" method="post" id="add_form_propertie">
                        <div class="row g-gs">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="name">Nom de la propriété</label>
                                    <div class="form-control-wrap">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button id="addPropertie" type="button" class="btn btn-primary">Enregistrer</button>
                                </div>
                            </div>
                        </div>
                    </form>
