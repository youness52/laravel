            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p>Vous avez un total de {{count($data['users'])}} Utilisateurs .</p>
                    </div>
                </div>
                    ...
                    <div class="card-inner position-relative card-tools-toggle ">
                                ...
                                <div class="card-tools">
                                    <div class="form-inline flex-nowrap gx-3">
                                        <div class="form-wrap w-150px">
                                            <select class="form-select form-select-sm" name="search" data-search="off" data-placeholder="Bulk Action">
                            ...
                            <div class="card-search search-wrap" data-search="search">
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control border-transparent form-focus-none" name="id" placeholder="Search by user name">
                    ...
                    <div class="card-inner p-0">
                        <div class="nk-tb-list nk-tb-ulist">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col tb-col-lg"><span class="sub-text">Email/PIN</span></div>
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden">
                                                    <a href="{{route('user.edit',$user->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Afficher">
                                                ...
                                                <li class="nk-tb-action-hidden">
                                                    <form action="{{route('user.destroy',$user->id)}}" method="post">
                                                        @csrf()
                                                        @method('DELETE')
                                                        <button class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Supprimer">
