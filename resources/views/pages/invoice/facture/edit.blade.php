...
<div class="nk-content-body">
    <form id="" method="post" action="{{route('facture.update',$data['invoice']->id)}}" autocomplete="off" enctype="multipart/form-data">
        @csrf()
        @method('PUT')
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Modifier La facture</h3>
                    ...
                    <div class="card card-bordered">
                        <div class="card-inner">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="form-label" for="modepay">Mode de Paiement </label>
                                        <div class="form-control-wrap">
                                            <select class="form-control form-select" name="modepay" id="modepay" required>
                                                @isset($data['payment_methods'])
                                                @foreach($data['payment_methods'] as $item)
                                                @if($item->id==$data['invoice']->payement_method_id )
                                ...
                                <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="form-label" for="image">Facture (PDF/image)</label>
                                            <div class="form-control-wrap">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="image" name="image" >
                                                    <label class="custom-file-label" for="image">PDF/image</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
