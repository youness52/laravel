                ...
                <div class="nk-block-head">
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Facture Nº :  <strong class="text-primary small">{{$data['invoice']->code}}</strong></h3>
                        ...
                        <div class="backbtn nk-block-head-content ">
                            <a href="{{route('facture.index')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex "><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                        </div>
                    </div>
                </div><!-- .nk-block-head -->
                <div class="nk-block">
