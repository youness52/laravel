...
<div class="nk-content-body">
    <form id="" method="post" action="{{route('facture.store')}}" autocomplete="off" enctype="multipart/form-data">
        @csrf()
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Ajouter une facture</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="image">Choose file PDF/image</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
