        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Liste des factures</h3>
                ...
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="{{route('facture.create')}}" class="btn btn-icon btn-trigger toggle-expand mr-n1" data-target="pageMenu"><em class="icon ni ni-menu-alt-r"></em></a>
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    <div class="drodown">
                                        <a href="{{route('facture.create')}}" class="dropdown-toggle btn btn-icon btn-primary" ><em class="icon ni ni-plus"></em></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card-inner p-0">
                        <div class="nk-tb-list nk-tb-ulist">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col tb-col-md"><span class="sub-text">Facture</span></div>
                            ...
                            @if(isset($data['invoice']))
                                @foreach($data['invoice'] as $invoice)
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-xxl ">
                                            <span class="badge badge-dim badge-primary"><a href="factures/{{$invoice->object}}">{{$invoice->object}}</a></span>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                            <li class="nk-tb-action-hidden">
                                                    <a href="{{route('facture.show',$invoice->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Preview / Print">
                                                        <em class="icon ni ni-eye"></em>
                                                    </a>
                                                </li>
                                            <li class="nk-tb-action-hidden">
                                                    <a href="{{route('facture.edit',$invoice->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="edit">
                                                        <em class="icon ni ni-edit"></em>
                                                    </a>
                                                </li>
                                                <li class="nk-tb-action-hidden">
                                                    <form action="{{route('facture.destroy',$invoice->id)}}" method="post">
                                                        @csrf()
                                                        @method('DELETE')
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="{{route('facture.edit',$invoice->id)}}" ><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                <li>
                                                                    <form action="{{route('facture.destroy',$invoice->id)}}" method="post">
                                                                        @csrf()
                                                                        @method('DELETE')
                                                                ...
                                                                <li><a href="{{route('facture.show',$invoice->id)}}" ><em class="icon ni ni-eye"></em><span>Preview / Print</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
