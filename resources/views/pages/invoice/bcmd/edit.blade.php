...
<div class="nk-content-body">
    <form id="" method="post" action="{{route('bcmd.update',$data['invoice']->id)}}" autocomplete="off" enctype="multipart/form-data">
        @csrf()
        @method('PUT')
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Modifier un bon de commande</h3>
                ...
                <div class="nk-block-head-content">
                    <div class=" nk-block">
                        <button type="submit" class=" btn btn-icon btn-primary"><em class="icon ni ni-save" title="Enregistrer"></em></button>  <span>  </span>
                        <button type="submit" class=" btn btn-icon btn-primary" value="transfer" name="transfer" title="transfer à récéption bon"><em class="icon ni ni-send"></em></button>
                    </div>
                    <!-- .toggle-wrap -->
                </div>
