        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Liste des Récéption des Commandes</h3>
                    <div class="nk-block-des text-soft">
                        <p>Vous avez un total de {{$data['invoice']->total()}} Bons.</p>
                    </div>
                </div>
                <!-- .nk-block-head-content -->
                <div class="nk-block-head-content">
                    <div class="toggle-wrap nk-block-tools-toggle">
                        <a href="{{route('breception.create')}}" class="btn btn-icon btn-trigger toggle-expand mr-n1" data-target="pageMenu"><em class="icon ni ni-menu-alt-r"></em></a>
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    <div class="drodown">
                                        <a href="{{route('breception.create')}}" class="dropdown-toggle btn btn-icon btn-primary" ><em class="icon ni ni-plus"></em></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="form-inline flex-nowrap gx-3">
                                    <div class="form-wrap w-150px">
                                        <select class="form-select form-select-sm" data-search="off" data-placeholder="Bulk Action">
                                            ...
                                            <option value="breceptions">breceptions</option>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-right">
                                                                <div class="dropdown-head">
                                                                    <span class="sub-title dropdown-title">Filtrer les breceptions</span>
                                                                </div>
                                    ...
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            ...
                                            <li class="nk-tb-action-hidden">
                                                    <a href="{{route('breception.show',$invoice->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Preview / Print">
                                                        <em class="icon ni ni-eye"></em>
                                                    </a>
                                                </li>
                                            <li class="nk-tb-action-hidden">
                                                    <a href="{{route('breception.edit',$invoice->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="edit">
                                                        <em class="icon ni ni-edit"></em>
                                                    </a>
                                                </li>
                                                <li class="nk-tb-action-hidden">
                                                    <form action="{{route('breception.destroy',$invoice->id)}}" method="post">
                                                        @csrf()
                                                        @method('DELETE')
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="{{route('breception.edit',$invoice->id)}}" ><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                <li>
                                                                    <form action="{{route('breception.destroy',$invoice->id)}}" method="post">
                                                                        @csrf()
                                                                        @method('DELETE')
                                                                ...
                                                                <li><a href="{{route('breception.show',$invoice->id)}}" ><em class="icon ni ni-eye"></em><span>Preview / Print</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
